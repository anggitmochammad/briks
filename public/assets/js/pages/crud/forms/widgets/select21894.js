var KTSelect2={
    init:function(){
        $(".select2, #kt_select2_1_validate").select2(
            {
                placeholder:"Pilih"
            }),
                        ...
                        $("#kt_select2_6").select2(
                            {
                                ...
                                allowClear:!0,ajax:{url:"https://api.github.com/search/repositories",
                                dataType:"json",
                                delay:250,
                                data:function(e){
                                    return{
