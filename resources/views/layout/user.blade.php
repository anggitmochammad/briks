    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <span class="symbol-label font-weight-bold" style="font-size: 80px">{{substr(Auth::user()->username,0,1)}}</span>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary">NIP : {{Auth::user()->nip_user}}</span>
                        </span>
                    </a>
                    <a href="{{url('logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                    <a href="{{url('profile')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Profile</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
